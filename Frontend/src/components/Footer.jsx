...
export default function Footer() {
    return (
        <div className="bg-bgBlue text-white py-10">

            <div className="container mx-auto text-center flex flex-col items-center space-y-4">

                <p className="text-md font-bold">VaccineView</p>

                <div className="flex h-5 items-center space-x-4 text-sm">
                    <FaXTwitter /><BsInstagram /><BsYoutube /><BsLinkedin />
                </div>

                <p className="text-sm">© 2024 Auckland ICT Graduate School. All rights reserved.</p>
