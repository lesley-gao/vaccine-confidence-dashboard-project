...
export default function VaxBanner() {
    return (
        <div className="h-screen bg-gradient-to-b from-customTheme-light to-customTheme-dark flex items-center justify-center">
            <div className="flex flex-col items-center w-3/4 text-white p-8 border-[1px] border-white rounded-lg bg-[#FFF2F2] bg-opacity-20">

                <div className="w-full mb-8 2xl:p-5 text-[23px] 2xl:text-3xl font-bold">
